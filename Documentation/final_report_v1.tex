...
\includegraphics[scale=0.3]{resources/dbmap_access}\\[1cm] 
Text Explanation here\\
\includegraphics[scale=0.3]{resources/IU_access}\\[1cm] 
\subsection{Intermediate Model}
\includegraphics[scale=0.3]{resources/Inter_schedule}\\[1cm] 
Text Explanation here\\
\includegraphics[scale=0.3]{resources/Inter_runs}\\[1cm] 
Text Explanation here\\
\subsection{Final Data Model}
Text Explanation here\\
\includegraphics[scale=0.3]{resources/Source_spring}\\[1cm] 
Text Explanation here\\
\includegraphics[scale=0.3]{resources/wh}\\[1cm] 
